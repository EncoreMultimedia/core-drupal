...
Picture Background Formatter only uses Image Styles for its output. Using the
Picture module's Sizes Attribute will produce unexpected or broken results.
